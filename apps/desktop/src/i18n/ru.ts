...
export const ru = defineLocale({
  ...
  skills: {
    ...
    hub: {
      ...
      pickerBlocked: 'Хаб навыков недоступен. Возможная причина — блокировка CDN или сетевые ограничения. Используйте поиск ниже или укажите зеркало в «skills.hub_url» в config.yaml.',
